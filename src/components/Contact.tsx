...
import { Mail, MessageSquare, Github, Linkedin, Twitter, ArrowUpRight } from 'lucide-react';
    ...
    <section id="contact" className="py-32 px-6 max-w-7xl mx-auto relative overflow-hidden">
      ...
      <div className="grid lg:grid-cols-2 gap-32 items-center">
        <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 1 }}>
          <span className="text-[10px] uppercase tracking-[0.8em] text-brand-cyan font-bold block mb-8">Transmission Protocol</span>
          <h2 className="text-5xl md:text-8xl font-display font-black tracking-tighter mb-8 uppercase leading-[0.85] text-white">CONNECT</h2>
          <p className="text-white/40 text-base font-light mb-12 max-w-md leading-relaxed border-l border-white/5 pl-8 italic">"This system is open."</p>

          <div className="space-y-6">
            <a href="mailto:afluk313@gmail.com" className="group relative flex items-center justify-between p-8 glass rounded-sm transition-all border-white/5 overflow-hidden w-full lg:w-[450px]">
              <div className="absolute top-0 left-0 w-[2px] h-full bg-brand-cyan shadow-[0_0_15px_#00f0ff]"></div>
              <div className="relative z-10 flex items-center gap-6">
                <div className="p-3 rounded-sm bg-brand-cyan/10 text-brand-cyan group-hover:scale-110 transition-all duration-500"><Mail size={20} /></div>
            ...
            <a href="https://instagram.com/aflu_k_" target="_blank" rel="noopener noreferrer" className="group relative flex items-center justify-between p-8 glass rounded-sm transition-all border-white/5 overflow-hidden w-full lg:w-[450px]">
              <div className="absolute top-0 left-0 w-[2px] h-full bg-brand-cyan/50"></div>
              <div className="relative z-10 flex items-center gap-6">
                <div className="p-3 rounded-sm bg-white/5 text-white/40 group-hover:text-brand-cyan group-hover:scale-110 transition-all duration-500"><MessageSquare size={20} /></div>
                <div className="text-left">
        ...
        <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 1, delay: 0.2 }} className="relative">
          <div className="aspect-square glass rounded-sm p-16 flex flex-col justify-between relative overflow-hidden group border-white/5 bg-black/40">
            ...
            <div className="relative z-10 flex justify-between items-end border-t border-white/5 pt-12">
              <div className="space-y-4">
                ...
                <div className="text-sm font-mono tracking-widest text-white/60">GMT+5:30 / KERALA</div>
              </div>
              <div className="flex gap-4">
                <a href="https://github.com/" target="_blank" rel="noopener noreferrer" title="GitHub" className="text-white/40 hover:text-brand-cyan transition-colors"><Github size={16} /></a>
                <a href="https://linkedin.com/" target="_blank" rel="noopener noreferrer" title="LinkedIn" className="text-white/40 hover:text-brand-cyan transition-colors"><Linkedin size={16} /></a>
                <a href="https://twitter.com/" target="_blank" rel="noopener noreferrer" title="Twitter" className="text-white/40 hover:text-brand-cyan transition-colors"><Twitter size={16} /></a>
              </div>
            </div>
